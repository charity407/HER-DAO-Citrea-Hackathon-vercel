...
import { LayoutDashboard, BookOpen, Award, BracketsIcon as Bridge, Wallet, Settings, Zap, LogOut } from "lucide-react"
...
export function Sidebar() {
  ...
  return (
    <div className="w-64 bg-black/50 border-r border-purple-700 p-6 flex flex-col h-screen">
      {/* Logo */}
      <div className="mb-8">
